  ...
  return (
    <div className="bg-[#d46b7426] flex justify-center items-center flex-col w-[100vw] max-md:py-[3em] md:py-[7em] h-[100%]">
      ...
      <div className="xl:grid-cols-3 max-md:px-[1rem] md:grid-cols-2 max-md:grid-cols-1 grid max-w-[1350px] w-[100%] items-center overflow-hidden justify-center gap-10 px-[3%] mt-[2rem]">
        <motion.div variants={{once:true}} initial={{opacity:0, x:-200}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col bg-white border-b-[7px] max-md:p-[1rem] md:p-[2rem]  border-[#a7585c]  rounded-xl">
        ...
        <motion.div initial={{opacity:0, x:0}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col bg-white border-b-[7px] max-md:p-[1rem] md:p-[2rem]  border-[#a7585c]  rounded-xl">
        ...
        <motion.div variants={{once:true}} initial={{opacity:0, x:-200}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col xl:hidden bg-white border-b-[7px] max-md:p-[1rem] md:p-[2rem]  border-[#a7585c] xl:w-[33%] rounded-xl">
          <div className="flex max-md:flex-col md:gap-5 max-md:gap2 md:items-center text-[#252525]">
            <img
        ...
        <motion.div variants={{once:true}} initial={{opacity:0, x:0}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col xl:hidden bg-white border-b-[7px] max-md:p-[1rem] md:p-[2rem]  border-[#a7585c] xl:w-[33%] rounded-xl">
          <div className="flex max-md:flex-col max-md:gap-2 md:gap-5 md:items-center text-[#252525]">
            <img
        ...
        <motion.div variants={{once:true}} initial={{opacity:0, x:200}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col bg-white xl:hidden border-b-[7px] max-md:p-[1rem] md:p-[2rem] border-[#a7585c] xl:w-[33%] rounded-xl">
          <div className="md:flex max-md:flex-col max-md:gap-2 md:gap-5 md:items-center text-[#252525]">
            <img
      ...
      <div className=" flex max-w-[1350px] max-xl:hidden w-[100%] items-center overflow-hidden justify-center gap-10 px-[3%] mt-[2rem]">
        <motion.div variants={{once:true}} initial={{opacity:0, x:-200}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col bg-white border-b-[7px] p-[2rem]  border-[#a7585c] w-[33%] rounded-xl">
        ...
        <motion.div variants={{once:true}} initial={{opacity:0, x:0}} whileInView={{opacity:1,x:0,transition:{duration:0.6}}} className="flex flex-col bg-white border-b-[7px] p-[2rem]  border-[#a7585c] w-[33%] rounded-xl">
          <div className="flex gap-5 items-center text-[#252525]">
            <img
              src="https://gtkit.rometheme.pro/glinic/wp-content/uploads/sites/51/2024/06/Services-Icon-2.png"
              alt=""
